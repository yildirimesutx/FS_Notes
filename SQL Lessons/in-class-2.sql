...
====================================================*/
	...
	SELECT * FROM invoices 
    WHERE NOT BillingCountry = "USA"	--WHERE  BillingCountry < >"USA" bu şekilde de kullanılabilir
    ORDER BY
    total DESC;
...
====================================================*/
	/* customers tablosunda Belgium, Norway veya  Canada  ülkelerinden sipariş veren
		...
		FROM customers
		WHERE country IN ("Norway", "Belgium", "Canada","USA");
...
/* albulms tablosunda Title (başlık) sutununda Greatest içeren kayıtların tüm bilgilerini 
	...
	/*SELECT *
	FROM invoices
	WHERE InvoiceDate BETWEEN "2010-01-01" and "2019-12-31"
	LIKE "%-02-%; */
