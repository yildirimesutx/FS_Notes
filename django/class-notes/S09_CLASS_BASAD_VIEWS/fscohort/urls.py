...
from .views import HomeView, StudentCreateView, StudentDetailViews, StudentListView, StudentUpdateView,  StudentDeleteView

# home,student_list, student_add, student_detail, student_update,student_delete
...
urlpatterns = [
    ...
    path('detail/<int:id>/', StudentDetailViews.as_view(), name="detail"),
