...
export default UseRefComponent;
  ...
  //  console.log(inputRef.current.value)
// input içindeki değer ulaşabiliyoruz 
  // ilgili taglaerin içine ref ile verilen değer ile o tag ulaşıyoruz, current ile style ve value lara ulaşıyoruz. useRef olarak import ediyoruz. null verilmesinin özel bir sebebi yok değer verilmeyede bilir